...
async def help_command(ctx):
    ...
    embed.add_field(name="!messages [@membre]", value="Te donne ton nombre de messages total", inline=False)
    embed.add_field(name="!rank", value="Te donne ton rang dans le serveur", inline=False)
    embed.add_field(name="!rank [@membre]", value="Te donne ton rang dans le serveur", inline=False)
